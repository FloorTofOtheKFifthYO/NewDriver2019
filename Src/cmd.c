...
static cmd_struct cmd_tbl[] = {
  ...
  CMD_ADD("write_ID","write the can id to flash",cmd_write_flash_func),
  ...
  CMD_ADD("set_duty", "set_duty", cmd_set_duty_func),
  ...
  CMD_ADD("brush_change", "brush motor channels change", cmd_brush_change_func),
  ...
  CMD_ADD("max_speed","max speed",cmd_max_speed_func),
  CMD_ADD("init","init",cmd_brushlessAbsolute_fonc)
